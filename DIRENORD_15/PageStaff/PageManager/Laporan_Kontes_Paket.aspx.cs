...
public partial class PageStaff_PageManager_Laporan_Kontes_Paket : System.Web.UI.Page
{
    ...
    public void loadChart5()
    {
        //try
        sqlCon.Open();
        SqlCommand sqlCmd = new SqlCommand("sp_report_jumlah_contest_perpaket_jumlah", sqlCon);
