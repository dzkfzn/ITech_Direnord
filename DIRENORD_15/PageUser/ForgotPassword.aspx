<%@ Page Language="C#" AutoEventWireup="true" CodeFile="ForgotPassword.aspx.cs" Inherits="PageUser_ForgotPassword" %>
         ...
         <div class="row" style="position: relative">
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                    <div class="back-link back-backend" >
                        <a href="Sign_In.aspx"  class="btn btn-primary">Kembali ke Menu Login</a>
                    </div>
                </div>
            </div>
        <div class="row">
            ...
            <div class="col-md-4 col-md-4 col-sm-4 col-xs-12">
                <div class="text-center m-b-md custom-login">
                    <h1 class="fc-heading__bright--md">Lupa Password</h1>
                </div>
                <div class="hpanel">
