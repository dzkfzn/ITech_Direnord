<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage_User.master" AutoEventWireup="true" CodeFile="Designer_Lihat_Kontes.aspx.cs" Inherits="PageUser_Lihat_Kontes" %>
        ...
        <div class="fl-main-page with-hellobar">
            <div class="fl-browse-contest">
                <div class="container">
                    <div class="row">
                        <div class="col-sm-12">
                            <h1 class="fc-heading__bright--md">Cari Kontes</h1>
                            <p class="fc-subheading hidden">7317 hasil pencarian</p>
                            <p class="fc-subheading">Ayo berkompetisi!</p>
                        </div>
                    </div>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-sm-10 col-md-4 fl-browse-contest__info">
                                            ...
                                            <div class="fl-browse-contest__icon-text" data-placement="bottom" data-toggle="tooltip">
                                                ...
                                                <p>
                                                    <asp:Label runat="server" Text='<%# Eval("Final") %>'></asp:Label>
                                                </p>
                                        ...
                                        <div class="col-sm-10 col-md-2 fl-browse-contest__info">
                                            <div class="fl-browse-contest__icon-text">
                                                <br />
                                                <asp:LinkButton ToolTip="Ikuti Kontes" CssClass="btn btn-success btn-lg" Text="Ikuti Kontes" ID="btnDetailView" OnClick="btnDetailView_Click" runat="server"
