...
public partial class PageUser_Designer_Lihat_Kontes_Yang_Diikuti : System.Web.UI.Page
{
    ...
    public DataSet FillGrid()
    {
        ...
        {
            // insert command
            SqlCommand sqlCmd = new SqlCommand("sp_designer_view_contest_ikut", sqlCon);
    ...
    public DataSet FillSearch()
    {
        ...
        {
            // insert command
            SqlCommand sqlCmd = new SqlCommand("sp_designer_view_contest_ikut_search", sqlCon);
            sqlCmd.Parameters.AddWithValue("@DesignerID", Session["Username"].ToString());
    ...
    protected void btnDetailView_Click(object sender, EventArgs e)
    {
        ...
        Response.Redirect("/PageUser/Designer_Detail_Kontes_Yang_Diikuti.aspx?contest=" + id);
